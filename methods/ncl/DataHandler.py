...
class DataHandler:
	def __init__(self):
		...
		elif args.data.startswith('god'):
			predir = '/home/akaxia/data/sparse datasets/sparse_gowalla_dist' + args.data[-1] + '/'
		self.predir = predir
		self.trnfile = predir + 'trnMat.pkl'
		self.tstfile = predir + 'tstMat.pkl'
		if args.noiseRate > 0:
			self.trnfile = predir + 'noised_%.2f.pkl' % args.noiseRate
	...
	def filter4SparseTest(self, trnMat, tstMat, usr=True):
		...
		filtTrn = filterTst(trnMat, pckNodeSet, usr)
		print('Num of trn entries', np.sum(filtTrn != 0))
